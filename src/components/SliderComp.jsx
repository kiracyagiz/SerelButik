...
const SliderComp = () => {
  ...
  return (
    <div>
      <Slider {...settings}>
        <div className="!flex flex-col md:flex-row justify-between  h-[fit] p-12 bg-purple-200 w-[80vh]">
          ...
          <img src={women} className="ml-20 md:ml-0 w-[150px] md:w-[350px] mr-0 md:mr-20 " alt="" />
        </div>
        <div className="!flex flex-col md:flex-row justify-between  p-12 bg-blue-200 w-[80vh]">
          ...
          <img src={womensec} className="ml-20 md:ml-0 w-[150px] md:w-[350px] mr-0 md:mr-20 " alt="" />
        </div>
        <div className="!flex flex-col md:flex-row justify-between  p-12 bg-pink-200 w-[80vh]">
          ...
          <img src={womenthird} className="ml-20 md:ml-0 w-[150px] md:w-[350px] mr-0 md:mr-20 " alt="" />
        </div>
      </Slider>
    </div>
  );
